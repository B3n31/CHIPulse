...
As far as we know, the first known study assessing the quantitative aspects of CSCW literature in this millenium was presented by Holsapple and Luo in 2003 [10]. The authors analyzed a total of 19,271 citations to track the impact of CSCW reseach from 1992 to 1999. Their findings revealed that the number of citations remained stable until the end of the last century. A co-authorship network analysis [4] demonstrated that CSCW authors maintained a great percentage of collaborative interactions with researchers from other fields between 1999 and 2003. However, physical proximity represented a critical factor in establishing collaborations between HCI and CSCW researchers. The authors went even further by applying co-authorship networks and citation data analysis on the ACM CSCW conference proceedings. Meanwhile, Jacovi and colleagues [11] mapped the field through a citation graph analysis of the ACM CSCW conference series between 1986 and 2004, identifying a small level of papers without citations. Extrapolating to the study of demographics in the ACM CSCW conference (1986-2002) [32], results revealed a high number of contributions by academics from USA (70-90%) compared with European researchers (10-30%). This study also denoted a great focus on group issues and design aspects of system prototypes and architectures as well as an increasing number of publications on ethnography and experimental approaches. A careful analysis of earlier studies led us to other quantitative examination of the ACM CSCW conference series (1998-2004) [33]. The authors identified a stable portion of design and evaluation studies, a high number of descriptive studies, a constant growth in papers testing hypotheses about group dynamics and collaboration issues through experiments, and a decline of non-empirical papers. Moreover, Keegan andco-workers [6] used scientometrics and social network analysis to identify that the impact of CSCW authors and papers is strongly influenced by their structural position within inner collaboration and citation networks. A quantitative analysis of CSCW research was conducted by Correia and colleagues [7]. This study identified a significant number of scientometric studies on CHI conference and related venues (e.g., [35]). Mubin and co-workers [36] argued that such studies have largely applied techniques that range from author and trend analysis to co-authorship networks, institutional-level analysis, topic modeling, and citation analysis.
"""
